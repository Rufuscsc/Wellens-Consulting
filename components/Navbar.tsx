    ...
    <nav className="flex justify-between mx-6 md:mx-20 mt-4 mb-4 relative">
      <div className="flex items-center justify-center gap-3">
        ...
        <a href="/" className="flex items-center gap-2 group">
          <span className="text-3xl font-bold tracking-tight text-amber-600 transition-colors group-hover:text-amber-700">
            Wellens<span className="text-slate-800"> Consulting</span>
          </span>
        </a>
      </div>
      <div className="hidden md:flex items-center gap-8 font-semibold text-sm uppercase tracking-widest text-[#1A1A2E]">
        <Link
          href=""
          className="font-Ovo group relative py-1 transition-all duration-300"
        >
          Home{" "}
      ...
      >
        <div className="flex flex-col mt-16 gap-8 font-medium text-lg">
          <Link href="" onClick={() => setIsOpen(false)} className="font-Ovo">
            Home
          </Link>
          <Link href="" onClick={() => setIsOpen(false)} className="font-Ovo">
            About
