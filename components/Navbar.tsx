    ...
    return (
        <nav className="flex justify-between mx-6 md:mx-20 mt-4 mb-4 relative">
            <div className="flex items-center justify-center gap-3">
                ...
                <h1 className="text-3xl font-medium text-amber-600">WC</h1>
            </div>
           <div className="hidden md:flex items-center gap-8 font-semibold text-sm uppercase tracking-widest text-[#1A1A2E]">
            ...
            <div className="hidden md:block">
                <button className="bg-white text-[#1A1A2E] px-6 py-2 rounded-md font-medium shadow-sm hover:shadow-md transition-all">
                    Contact us
                </button>
            </div>
